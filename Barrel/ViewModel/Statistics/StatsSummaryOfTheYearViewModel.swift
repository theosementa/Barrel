//
//  StatsSummaryOfTheYearViewModel.swift
//  Barrel
//
...
extension StatsSummaryOfTheYearViewModel {
...
extension StatsSummaryOfTheYearViewModel {
    ...
    func averageOfAmount() -> Double {
        ...
        if entriesOfTheYear.count > 1 {
            return pricesAdditioned / Double(entriesOfTheYear.count)
        } else {
            return 0
        }
    }
    ...
    func averageOfLitreConsumed() -> Double {
        ...
        if entriesOfTheYear.count > 1 && litresAdditioned > 0{
            return litresAdditioned / Double(entriesOfTheYear.count - 1)
        } else { return 0 }
    }
